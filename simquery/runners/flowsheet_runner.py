"""
simquery/runners/flowsheet_runner.py
========================================
...
def _make_build_heater(sim):
    ...
    def build_heater(name: str, T_out_C: float,
        ...
        """
        from simquery.core.units.heat_exchanger import build_heater as _bh
...
def _make_build_cooler(sim):
    ...
    def build_cooler(name: str, T_out_C: float,
        ...
        """
        from simquery.core.units.heat_exchanger import build_cooler as _bc
...
def _make_build_compressor(sim):
    def build_compressor(name: str, P_out_bar: float, efficiency: float = 0.75,
        ...
        """
        from simquery.core.units.compressor_expander import build_compressor as _bc
...
def _make_build_expander(sim):
    def build_expander(name: str, P_out_bar: float, efficiency: float = 0.75,
        ...
        """
        from simquery.core.units.compressor_expander import build_expander as _be
...
def _make_build_hx(sim):
    def build_hx(name: str, calc_mode: str,
        ...
        """
        from simquery.core.units.heat_exchanger import build_hx as _bh
...
def _make_extract(comp_names):
    ...
    def extract(stream_obj, label: str) -> dict:
        ...
        """
        from simquery.core.units.heat_exchanger import hx_stream_results
