...
LLM2_SYSTEM_PROMPT_PATH = os.path.join(_HERE, "prompts", "llm2_system_prompt.txt")

with open(LLM2_SYSTEM_PROMPT_PATH, "r", encoding="utf-8") as f:
    LLM2_SYSTEM_PROMPT = f.read()

FLOWSHEET_LLM2_SYSTEM_PROMPT_PATH = os.path.join(_HERE, "prompts", "llm2_flowsheet_prompt.txt")

with open(FLOWSHEET_LLM2_SYSTEM_PROMPT_PATH, "r", encoding="utf-8") as f:
    FLOWSHEET_LLM2_SYSTEM_PROMPT = f.read()

GUARD_PROMPT_PATH = os.path.join(_HERE, "prompts", "guard_prompt.txt")
...
from simquery.runners.flash_runner import OUTPUT_DIR as _OUTPUT_DIR
...
def run_full_pipeline(user_question: str) -> None:
    ...
    if task_json.get("task_type") == "txy":
        from simquery.runners.txy_engine import run_txy_task
    ...
    if task_json.get("task_type") == "flowsheet":
        ...
        from simquery.runners.flowsheet_runner import run_flowsheet_master
    ...
    if task_json.get("task_type") == "heat":
        ...
        from simquery.runners.heat_runner import run_heat_master
    ...
    if task_json.get("task_type") == "comp":
        ...
        from simquery.runners.comp_runner import run_comp_master
    ...
    if task_json.get("task_type") == "hx":
        ...
        from simquery.runners.hx_runner import run_hx_master
    ...
    from simquery.runners.flash_runner import run_flash_master
