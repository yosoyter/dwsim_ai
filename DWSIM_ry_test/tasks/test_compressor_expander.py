"""
DWSIM_ry_test/tasks/test_compressor_expander.py
================================================
...
CLI:
  python DWSIM_ry_test/tasks/test_compressor_expander.py --test compressor
  python DWSIM_ry_test/tasks/test_compressor_expander.py --test expander
  python DWSIM_ry_test/tasks/test_compressor_expander.py --test all
"""
...
from DWSIM_ry_test.lib.units.compressor_expander import (
...
def _init(components: list, package: str = "PR"):
    ...
    from DWSIM_ry_test.lib.dwsim_core import init_dwsim, create_flowsheet, select_property_package
